...
Config
    { --font              = "xft:xos4 Terminus:pixelsize=16:antialias=true:hinting=true"
      font              = "xft:Envy code r:pixelsize=14:antialias=true:hinting=true"
...
--            ] 36000
        ...
        --    ] 20
        , Run Date "<fc=#268bd2><fn=1>\xf073</fn> %a %_d %b %Y | d.%j </fc>   <fc=#2AA198><fn=1></fn> %H:%M:%S</fc>" "date" 20
...
--            ] 10 
        ...
        , Run Com "/home/gio/.xmonad/scripts/status-vol" [] "volume" 1
        , Run Com "/home/gio/.xmonad/scripts/status-net" [] "net" 10
        , Run Com "/home/gio/.xmonad/scripts/status-keyboard" [] "kb" 10
	, Run Com "/home/gio/.xmonad/scripts/batterybar" [] "battery" 20
        --, Run StdinReader
        ...
        , template           = " %UnsafeStdinReader% }{ %cpu%  %net%   %volume%   %battery%   %date%   %kb%              "
